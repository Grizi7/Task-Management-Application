...
@section('content')
    ...
    <section class="text-center py-5">
        <div class="container">
            ...
            <p>Organize your daily tasks, set reminders, and stay focused on what's important. It's that simple!</p>
            @guest
                <a href="{{ route('login') }}" class="btn btn-primary btn-lg mt-3">Log in to Start</a>
            @else
                <a href="" class="btn btn-primary btn-lg mt-3">Start Managing Tasks</a>
            @endguest
        </div>
    </section>
